...
def build(input_tensor, num_classes=2, is_training=True, padding='SAME', reuse=None, keep_prob=0.5):
    with tf.variable_scope('lenet3', 'image_to_head', reuse=reuse):
        ...
        net = slim.conv2d(net, num_classes, [1, 1],
                          ...
                          scope='fc4')
        '''
    return L.final_inner_product(input_tensor=net, name='fc_final', num_output=num_classes)
    #return net
